...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 更多菜单</a>
  <ul>
    ...
    <li><a href="${pageContext.request.contextPath}/admin/term"><i class="icon icon-th"></i> <span>学期信息</span></a></li>
     <li class="submenu"> <a href="#"><i class="icon icon-info-sign"></i> <span>学校信息管理</span></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-info-sign"></i> <span>课程管理</span></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-info-sign"></i> <span>缓存管理</span></a>
      <ul>
  	...
  	<li><a href="${pageContext.request.contextPath}/admin/notice"><i class="icon icon-tint"></i> <span>编辑公告</span></a></li>
