	...
	<div id="content-header">
		<div id="breadcrumb">
			<a href="index.html" title="Go to Home" class="tip-bottom"><i
				class="icon-home"></i> 首页</a> <a href="${pageContext.request.contextPath}/admin/course/courses" class="current">所有课程</a>
		</div>
	</div>
	<!--End-breadcrumbs-->
...
<script src="${pageContext.request.contextPath}/static/js/admin/page/course/course.js"></script>
</body>
</html>